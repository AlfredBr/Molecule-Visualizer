...
void buildRandomMolecule(Molecule* mol) {
    ...
    mol->formula[0] = '\0';  // No formula for random molecules
...
struct MoleculeInfo {
    ...
    const char* name;
    const char* formula;  // Chemical formula (e.g., "H2O", "C6H12O6")
    int category;
...
static MoleculeInfo molecules[] = {
    ...
    { buildWater, "Water", "H2O", CAT_SIMPLE, "Universal solvent",
    ...
    { buildMethane, "Methane", "CH4", CAT_SIMPLE, "Natural gas",
    ...
    { buildBenzene, "Benzene", "C6H6", CAT_ORGANIC, "Aromatic ring",
    ...
    { buildEthanol, "Ethanol", "C2H5OH", CAT_ORGANIC, "Alcohol",
    ...
    { buildCaffeine, "Caffeine", "C8H10N4O2", CAT_PHARMA, "Stimulant",
    ...
    { buildAdenine, "Adenine", "C5H5N5", CAT_ENERGY, "DNA nucleobase",
    ...
    { buildGlucose, "Glucose", "C6H12O6", CAT_SUGARS, "Blood sugar",
    ...
    { buildAspirin, "Aspirin", "C9H8O4", CAT_PHARMA, "Pain reliever",
    ...
    { buildAmmonia, "Ammonia", "NH3", CAT_SIMPLE, "Cleaning agent",
    ...
    { buildCarbonDioxide, "Carbon Dioxide", "CO2", CAT_SIMPLE, "Greenhouse gas",
    ...
    { buildFormaldehyde, "Formaldehyde", "CH2O", CAT_ORGANIC, "Preservative",
    ...
    { buildAcetone, "Acetone", "C3H6O", CAT_ORGANIC, "Solvent",
    ...
    { buildAceticAcid, "Acetic Acid", "CH3COOH", CAT_ACIDS, "Vinegar",
    ...
    { buildPropane, "Propane", "C3H8", CAT_ORGANIC, "Fuel gas",
    ...
    { buildButane, "Butane", "C4H10", CAT_ORGANIC, "Lighter fuel",
    ...
    { buildCyclohexane, "Cyclohexane", "C6H12", CAT_ORGANIC, "Cyclic alkane",
    ...
    { buildNaphthalene, "Naphthalene", "C10H8", CAT_ORGANIC, "Mothballs",
    ...
    { buildUrea, "Urea", "CH4N2O", CAT_ORGANIC, "Metabolic waste",
    ...
    { buildGlycine, "Glycine", "C2H5NO2", CAT_AMINO_ACIDS, "Simplest amino acid",
    ...
    { buildAlanine, "Alanine", "C3H7NO2", CAT_AMINO_ACIDS, "Nonpolar amino acid",
    ...
    { buildThymine, "Thymine", "C5H6N2O2", CAT_ENERGY, "DNA nucleobase (T)",
    ...
    { buildCytosine, "Cytosine", "C4H5N3O", CAT_ENERGY, "DNA/RNA nucleobase (C)",
    ...
    { buildGuanine, "Guanine", "C5H5N5O", CAT_ENERGY, "DNA/RNA nucleobase (G)",
    ...
    { buildDopamine, "Dopamine", "C8H11NO2", CAT_NEUROTRANS, "Reward neurotransmitter",
    ...
    { buildSerotonin, "Serotonin", "C10H12N2O", CAT_NEUROTRANS, "Mood neurotransmitter",
    ...
    { buildNitricOxide, "Nitric Oxide", "NO", CAT_SIMPLE, "Signaling molecule",
    ...
    { buildHydrogenPeroxide, "Hydrogen Peroxide", "H2O2", CAT_HOUSEHOLD, "Oxidizer",
    ...
    { buildSulfuricAcid, "Sulfuric Acid", "H2SO4", CAT_ACIDS, "Industrial acid",
    ...
    { buildPhosphoricAcid, "Phosphoric Acid", "H3PO4", CAT_ACIDS, "Cola acid",
    ...
    { buildToluene, "Toluene", "C7H8", CAT_ORGANIC, "Solvent",
    ...
    { buildPhenol, "Phenol", "C6H5OH", CAT_ORGANIC, "Carbolic acid",
    ...
    { buildAcetylene, "Acetylene", "C2H2", CAT_ORGANIC, "Welding gas",
    ...
    { buildOxygen, "Oxygen", "O2", CAT_SIMPLE, "Molecular oxygen",
    ...
    { buildNitrogen, "Nitrogen", "N2", CAT_SIMPLE, "Molecular nitrogen",
    ...
    { buildHydrogen, "Hydrogen", "H2", CAT_SIMPLE, "Molecular hydrogen",
    ...
    { buildOzone, "Ozone", "O3", CAT_SIMPLE, "Triatomic oxygen",
    ...
    { buildCarbonMonoxide, "Carbon Monoxide", "CO", CAT_SIMPLE, "Toxic gas",
    ...
    { buildNitrousOxide, "Nitrous Oxide", "N2O", CAT_SIMPLE, "Laughing gas",
    ...
    { buildSulfurDioxide, "Sulfur Dioxide", "SO2", CAT_SIMPLE, "Volcanic gas",
    ...
    { buildHydrogenChloride, "Hydrochloric Acid", "HCl", CAT_ACIDS, "Stomach acid",
    ...
    { buildNitricAcid, "Nitric Acid", "HNO3", CAT_ACIDS, "Strong acid",
    ...
    { buildMethanol, "Methanol", "CH3OH", CAT_ORGANIC, "Wood alcohol",
    ...
    { buildEthane, "Ethane", "C2H6", CAT_ORGANIC, "Natural gas component",
    ...
    { buildPropene, "Propene", "C3H6", CAT_ORGANIC, "Propylene",
    ...
    { buildIsopropanol, "Isopropanol", "C3H8O", CAT_ORGANIC, "Rubbing alcohol",
    ...
    { buildEthyleneGlycol, "Ethylene Glycol", "C2H6O2", CAT_ORGANIC, "Antifreeze",
    ...
    { buildGlycerol, "Glycerol", "C3H8O3", CAT_ORGANIC, "Glycerin",
    ...
    { buildAcetaldehyde, "Acetaldehyde", "C2H4O", CAT_ORGANIC, "Ethanal",
    ...
    { buildFormicAcid, "Formic Acid", "CH2O2", CAT_ACIDS, "Ant venom",
    ...
    { buildLacticAcid, "Lactic Acid", "C3H6O3", CAT_ACIDS, "Muscle fatigue",
    ...
    { buildEthylAcetate, "Ethyl Acetate", "C4H8O2", CAT_ORGANIC, "Nail polish solvent",
    ...
    { buildAcetonitrile, "Acetonitrile", "C2H3N", CAT_ORGANIC, "Polar solvent",
    ...
    { buildDMSO, "DMSO", "C2H6OS", CAT_ORGANIC, "Dimethyl sulfoxide",
    ...
    { buildDichloromethane, "Dichloromethane", "CH2Cl2", CAT_ORGANIC, "Paint stripper",
    ...
    { buildChlorobenzene, "Chlorobenzene", "C6H5Cl", CAT_ORGANIC, "Aromatic halide",
    ...
    { buildNitrobenzene, "Nitrobenzene", "C6H5NO2", CAT_ORGANIC, "Almond odor",
    ...
    { buildAniline, "Aniline", "C6H7N", CAT_ORGANIC, "Dye precursor",
    ...
    { buildStyrene, "Styrene", "C8H8", CAT_PLASTICS, "Polystyrene monomer",
    ...
    { buildBenzoicAcid, "Benzoic Acid", "C7H6O2", CAT_ACIDS, "Preservative",
    ...
    { buildValine, "Valine", "C5H11NO2", CAT_AMINO_ACIDS, "Branched-chain AA",
    ...
    { buildLeucine, "Leucine", "C6H13NO2", CAT_AMINO_ACIDS, "Essential AA",
    ...
    { buildEthylene, "Ethylene", "C2H4", CAT_ORGANIC, "Plant hormone",
    ...
    { buildHydrogenSulfide, "Hydrogen Sulfide", "H2S", CAT_SIMPLE, "Rotten egg smell",
    ...
    { buildChloroform, "Chloroform", "CHCl3", CAT_ORGANIC, "Anesthetic",
    ...
    { buildTertButanol, "tert-Butanol", "C4H10O", CAT_ORGANIC, "Tertiary alcohol",
    ...
    { buildButanol, "1-Butanol", "C4H10O", CAT_ORGANIC, "Butyl alcohol",
    ...
    { buildDiethylEther, "Diethyl Ether", "C4H10O", CAT_ORGANIC, "Classic anesthetic",
    ...
    { buildMTBE, "MTBE", "C5H12O", CAT_ORGANIC, "Fuel additive",
    ...
    { buildTHF, "THF", "C4H8O", CAT_ORGANIC, "Tetrahydrofuran",
    ...
    { buildDioxane, "1,4-Dioxane", "C4H8O2", CAT_ORGANIC, "Cyclic ether",
    ...
    { buildDMF, "DMF", "C3H7NO", CAT_ORGANIC, "Dimethylformamide",
    ...
    { buildCarbonTetrachloride, "Carbon Tetrachloride", "CCl4", CAT_ORGANIC, "Ozone depleter",
    ...
    { buildMethylAcetate, "Methyl Acetate", "C3H6O2", CAT_ORGANIC, "Ester solvent",
    ...
    { buildAceticAnhydride, "Acetic Anhydride", "C4H6O3", CAT_ORGANIC, "Acetylating agent",
    ...
    { buildPropionicAcid, "Propionic Acid", "C3H6O2", CAT_ACIDS, "Preservative",
    ...
    { buildButyricAcid, "Butyric Acid", "C4H8O2", CAT_ACIDS, "Rancid butter",
    ...
    { buildSuccinicAcid, "Succinic Acid", "C4H6O4", CAT_ACIDS, "Krebs cycle",
    ...
    { buildBenzaldehyde, "Benzaldehyde", "C7H6O", CAT_FLAVORS, "Almond flavor",
    ...
    { buildBromobenzene, "Bromobenzene", "C6H5Br", CAT_ORGANIC, "Aromatic halide",
    ...
    { buildPXylene, "p-Xylene", "C8H10", CAT_ORGANIC, "Para-xylene",
    ...
    { buildAnisole, "Anisole", "C7H8O", CAT_ORGANIC, "Methoxybenzene",
    ...
    { buildPhenylacetylene, "Phenylacetylene", "C8H6", CAT_ORGANIC, "Aromatic alkyne",
    ...
    { buildFructose, "Fructose", "C6H12O6", CAT_SUGARS, "Fruit sugar",
    ...
    { buildRibose, "Ribose", "C5H10O5", CAT_SUGARS, "RNA sugar",
    ...
    { buildDeoxyribose, "Deoxyribose", "C5H10O4", CAT_SUGARS, "DNA sugar",
    ...
    { buildIsoleucine, "Isoleucine", "C6H13NO2", CAT_AMINO_ACIDS, "Branched-chain AA",
    ...
    { buildSerine, "Serine", "C3H7NO3", CAT_AMINO_ACIDS, "Polar amino acid",
    ...
    { buildThreonine, "Threonine", "C4H9NO3", CAT_AMINO_ACIDS, "Essential AA",
    ...
    { buildAsparticAcid, "Aspartic Acid", "C4H7NO4", CAT_AMINO_ACIDS, "Acidic AA",
    ...
    { buildGlutamicAcid, "Glutamic Acid", "C5H9NO4", CAT_AMINO_ACIDS, "MSG precursor",
    ...
    { buildLysine, "Lysine", "C6H14N2O2", CAT_AMINO_ACIDS, "Basic AA",
    ...
    { buildHistidine, "Histidine", "C6H9N3O2", CAT_AMINO_ACIDS, "Aromatic AA",
    ...
    { buildPhenylalanine, "Phenylalanine", "C9H11NO2", CAT_AMINO_ACIDS, "Aromatic AA",
    ...
    { buildTyrosine, "Tyrosine", "C9H11NO3", CAT_AMINO_ACIDS, "Aromatic AA",
    ...
    { buildTryptophan, "Tryptophan", "C11H12N2O2", CAT_AMINO_ACIDS, "Aromatic AA",
    ...
    { buildProline, "Proline", "C5H9NO2", CAT_AMINO_ACIDS, "Cyclic AA",
    ...
    { buildCysteine, "Cysteine", "C3H7NO2S", CAT_AMINO_ACIDS, "Sulfur AA",
    ...
    { buildMethionine, "Methionine", "C5H11NO2S", CAT_AMINO_ACIDS, "Sulfur AA",
    ...
    { buildPyruvate, "Pyruvate", "C3H4O3", CAT_ENERGY, "Glycolysis product",
    ...
    { buildArginine, "Arginine", "C6H14N4O2", CAT_AMINO_ACIDS, "Basic AA",
    ...
    { buildAsparagine, "Asparagine", "C4H8N2O3", CAT_AMINO_ACIDS, "Polar AA",
    ...
    { buildGlutamine, "Glutamine", "C5H10N2O3", CAT_AMINO_ACIDS, "Polar AA",
    ...
    { buildHydroxyproline, "Hydroxyproline", "C5H9NO3", CAT_AMINO_ACIDS, "Collagen AA",
    ...
    // === VITAMINS (103-116) ===
    { buildAscorbicAcid, "Vitamin C", "C6H8O6", CAT_VITAMINS, "Ascorbic acid",
    ...
    { buildThiamine, "Vitamin B1", "C12H17N4OS", CAT_VITAMINS, "Thiamine",
    ...
    { buildRiboflavin, "Vitamin B2", "C17H20N4O6", CAT_VITAMINS, "Riboflavin",
    ...
    { buildNiacin, "Vitamin B3", "C6H5NO2", CAT_VITAMINS, "Niacin",
    ...
    { buildPanthothenicAcid, "Vitamin B5", "C9H17NO5", CAT_VITAMINS, "Pantothenic acid",
    ...
    { buildPyridoxine, "Vitamin B6", "C8H11NO3", CAT_VITAMINS, "Pyridoxine",
    ...
    { buildBiotin, "Vitamin B7", "C10H16N2O3S", CAT_VITAMINS, "Biotin",
    ...
    { buildFolicAcid, "Vitamin B9", "C19H19N7O6", CAT_VITAMINS, "Folic acid",
    ...
    { buildRetinol, "Vitamin A", "C20H30O", CAT_VITAMINS, "Retinol",
    ...
    { buildBetaCarotene, "Beta-Carotene", "C40H56", CAT_VITAMINS, "Provitamin A",
    ...
    { buildCholecalciferol, "Vitamin D3", "C27H44O", CAT_VITAMINS, "Cholecalciferol",
    ...
    { buildAlphaTocopherol, "Vitamin E", "C29H50O2", CAT_VITAMINS, "Alpha-tocopherol",
    ...
    { buildPhylloquinone, "Vitamin K1", "C31H46O2", CAT_VITAMINS, "Phylloquinone",
    ...
    { buildNicotinamide, "Nicotinamide", "C6H6N2O", CAT_VITAMINS, "B3 amide form",
    ...
    { buildNiacinamide, "Niacinamide", "C6H6N2O", CAT_VITAMINS, "Vitamin B3 variant",
    ...
    { buildCocaine, "Cocaine", "C17H21NO4", CAT_CONTROLLED, "Stimulant alkaloid",
    ...
    { buildHeroin, "Heroin", "C21H23NO5", CAT_CONTROLLED, "Opioid",
    ...
    { buildFentanyl, "Fentanyl", "C22H28N2O", CAT_CONTROLLED, "Synthetic opioid",
    ...
    { buildPropofol, "Propofol", "C12H18O", CAT_CONTROLLED, "IV anesthetic",
    ...
    { buildTHC, "THC", "C21H30O2", CAT_CONTROLLED, "Cannabis active",
    ...
    { buildCreatine, "Creatine", "C4H9N3O2", CAT_ENERGY, "Muscle energy",
    ...
    { buildOctane, "Octane", "C8H18", CAT_ORGANIC, "Gasoline component",
    ...
    { buildSimvastatin, "Simvastatin", "C25H38O5", CAT_PHARMA, "Cholesterol drug",
    ...
    { buildIbuprofen, "Ibuprofen", "C13H18O2", CAT_PHARMA, "NSAID",
    ...
    { buildNaproxen, "Naproxen", "C14H14O3", CAT_PHARMA, "NSAID",
    ...
    { buildDiclofenac, "Diclofenac", "C14H11Cl2NO2", CAT_PHARMA, "NSAID",
    ...
    { buildIndomethacin, "Indomethacin", "C19H16ClNO4", CAT_PHARMA, "NSAID",
    ...
    { buildCelecoxib, "Celecoxib", "C17H14F3N3O2S", CAT_PHARMA, "COX-2 inhibitor",
    ...
    { buildMeloxicam, "Meloxicam", "C14H13N3O4S2", CAT_PHARMA, "NSAID",
    ...
    { buildAcetaminophen, "Acetaminophen", "C8H9NO2", CAT_PHARMA, "Paracetamol",
    ...
    { buildTestosterone, "Testosterone", "C19H28O2", CAT_HORMONES, "Male sex hormone",
    ...
    { buildDHT, "DHT", "C19H30O2", CAT_HORMONES, "Dihydrotestosterone",
    ...
    { buildAndrostenedione, "Androstenedione", "C19H26O2", CAT_HORMONES, "Androgen precursor",
    ...
    { buildEstradiol, "Estradiol", "C18H24O2", CAT_HORMONES, "Primary estrogen",
    ...
    { buildEstrone, "Estrone", "C18H22O2", CAT_HORMONES, "Postmenopausal estrogen",
    ...
    { buildEstriol, "Estriol", "C18H24O3", CAT_HORMONES, "Pregnancy estrogen",
    ...
    { buildProgesterone, "Progesterone", "C21H30O2", CAT_HORMONES, "Pregnancy hormone",
    ...
    { buildCortisol, "Cortisol", "C21H30O5", CAT_HORMONES, "Stress hormone",
    ...
    { buildCortisone, "Cortisone", "C21H28O5", CAT_HORMONES, "Cortisol precursor",
    ...
    { buildMSG, "Monosodium Glutamate", "C5H8NO4Na", CAT_HOUSEHOLD, "Flavor enhancer",
    ...
    { buildGlycerin, "Glycerin", "C3H8O3", CAT_HOUSEHOLD, "Humectant moisturizer",
    ...
    // === ACIDS (152-167) ===
    { buildCitricAcid, "Citric Acid", "C6H8O7", CAT_ACIDS, "Citrus fruits",
    ...
    { buildOxalicAcid, "Oxalic Acid", "C2H2O4", CAT_ACIDS, "Rust remover",
    ...
    { buildTartaricAcid, "Tartaric Acid", "C4H6O6", CAT_ACIDS, "Wine acid",
    ...
    { buildMalicAcid, "Malic Acid", "C4H6O5", CAT_ACIDS, "Apple acid",
    ...
    { buildGlycolicAcid, "Glycolic Acid", "C2H4O3", CAT_ACIDS, "AHA exfoliant",
    ...
    { buildSalicylicAcid, "Salicylic Acid", "C7H6O3", CAT_ACIDS, "BHA acne fighter",
    ...
    { buildAcrylicAcid, "Acrylic Acid", "C3H4O2", CAT_ACIDS, "Polymer precursor",
    ...
    // === PLASTICS (162-179) ===
    { buildVinylChloride, "Vinyl Chloride", "C2H3Cl", CAT_PLASTICS, "PVC monomer",
    ...
    { buildAcrylonitrile, "Acrylonitrile", "C3H3N", CAT_PLASTICS, "ABS component",
    ...
    { buildButadiene, "1,3-Butadiene", "C4H6", CAT_PLASTICS, "Rubber/ABS",
    ...
    { buildBisphenolA, "Bisphenol A", "C15H16O2", CAT_PLASTICS, "Polycarbonate",
    ...
    { buildTerephthalicAcid, "Terephthalic Acid", "C8H6O4", CAT_PLASTICS, "PET monomer",
    ...
    { buildVinylAcetate, "Vinyl Acetate", "C4H6O2", CAT_PLASTICS, "EVA monomer",
    ...
    { buildDimethylsiloxane, "Dimethylsiloxane", "C2H6OSi", CAT_PLASTICS, "Silicone monomer",
    ...
    { buildAdipicAcid, "Adipic Acid", "C6H10O4", CAT_PLASTICS, "Nylon monomer",
    ...
    { buildHexamethylenediamine, "Hexamethylenediamine", "C6H16N2", CAT_PLASTICS, "Nylon monomer",
    ...
    { buildIsoprene, "Isoprene", "C5H8", CAT_PLASTICS, "Natural rubber",
    ...
    { buildPEDimer, "PE Dimer", "C4H10", CAT_PLASTICS, "Polyethylene",
    ...
    { buildPPDimer, "PP Dimer", "C6H14", CAT_PLASTICS, "Polypropylene",
    ...
    { buildPVCTrimer, "PVC Trimer", "C6H9Cl3", CAT_PLASTICS, "PVC oligomer",
    ...
    { buildPSDimer, "PS Dimer", "C16H16", CAT_PLASTICS, "Polystyrene",
    ...
    { buildPTFETrimer, "PTFE Trimer", "C6F12", CAT_PLASTICS, "Teflon oligomer",
    ...
    // === FATTY ACIDS (180-189) ===
    { buildElaidicAcid, "Elaidic Acid", "C18H34O2", CAT_FATS, "Industrial trans fat",
    ...
    { buildOleicAcid, "Oleic Acid", "C18H34O2", CAT_FATS, "Olive oil",
    ...
    { buildVaccenicAcid, "Vaccenic Acid", "C18H34O2", CAT_FATS, "Natural trans fat",
    ...
    { buildTransPalmitoleicAcid, "trans-Palmitoleic Acid", "C16H30O2", CAT_FATS, "Dairy fat",
    ...
    { buildLinoelaidicAcid, "Linoelaidic Acid", "C18H32O2", CAT_FATS, "Hydrogenation",
    ...
    { buildRumenicAcid, "Rumenic Acid", "C18H32O2", CAT_FATS, "Conjugated linoleic",
    ...
    { buildStearicAcid, "Stearic Acid", "C18H36O2", CAT_FATS, "Saturated fat",
    ...
    { buildPalmiticAcid, "Palmitic Acid", "C16H32O2", CAT_FATS, "Palm oil",
    ...
    { buildLinoleicAcid, "Linoleic Acid", "C18H32O2", CAT_FATS, "Essential FA",
    ...
    { buildAlphaLinolenicAcid, "Alpha-Linolenic Acid", "C18H30O2", CAT_FATS, "Plant omega-3",
    ...
    { buildIronPentacarbonyl, "Iron Pentacarbonyl", "Fe(CO)5", CAT_METALS, "Toxic metal compound",
    ...
    { buildVerdigris, "Verdigris", "Cu2CO3(OH)2", CAT_METALS, "Copper carbonate",
    ...
    { buildFerrocene, "Ferrocene", "Fe(C5H5)2", CAT_METALS, "Sandwich compound",
    ...
    { buildCisplatin, "Cisplatin", "Pt(NH3)2Cl2", CAT_METALS, "Cancer drug",
    ...
    { buildAluminumOxide, "Aluminum Oxide", "Al2O3", CAT_METALS, "Alumina",
    ...
    { buildGABA, "GABA", "C4H9NO2", CAT_NEUROTRANS, "Inhibitory NT",
    ...
    { buildGlutamate, "Glutamate", "C5H9NO4", CAT_NEUROTRANS, "Excitatory NT",
    ...
    { buildNorepinephrine, "Norepinephrine", "C8H11NO3", CAT_NEUROTRANS, "Fight-or-flight",
    ...
    { buildATP, "ATP", "C10H16N5O13P3", CAT_ENERGY, "Energy currency",
    ...
    { buildADP, "ADP", "C10H15N5O10P2", CAT_ENERGY, "Adenosine diphosphate",
    ...
    { buildNADH, "NADH", "C21H29N7O14P2", CAT_ENERGY, "Electron carrier",
    ...
    { buildPenicillinG, "Penicillin G", "C16H18N2O4S", CAT_PHARMA, "Beta-lactam",
    ...
    { buildAmoxicillin, "Amoxicillin", "C16H19N3O5S", CAT_PHARMA, "Broad-spectrum",
    ...
    { buildVancomycin, "Vancomycin", "C66H75Cl2N9O24", CAT_PHARMA, "Glycopeptide",
    ...
    { buildMethotrexate, "Methotrexate", "C20H22N8O5", CAT_PHARMA, "Immunosuppressant",
    ...
    { buildHydroxychloroquine, "Hydroxychloroquine", "C18H26ClN3O", CAT_PHARMA, "Antimalarial/Immunosuppressant",
    ...
    { buildFluconazole, "Fluconazole", "C13H12F2N6O", CAT_PHARMA, "Antifungal triazole",
    ...
    // === EXPLOSIVES (209-211) ===
    { buildTNT, "TNT", "C7H5N3O6", CAT_OTHER, "Trinitrotoluene",
    ...
    { buildNitroglycerin, "Nitroglycerin", "C3H5N3O9", CAT_PHARMA, "Explosive/angina",
    ...
    { buildRDX, "RDX", "C3H6N6O6", CAT_OTHER, "Military explosive",
    ...
    // === SWEETENERS (212-218) ===
    { buildSucrose, "Sucrose", "C12H22O11", CAT_SUGARS, "Disaccharide",
    ...
    { buildLactose, "Lactose", "C12H22O11", CAT_SUGARS, "Milk sugar disaccharide",
    ...
    { buildMaltose, "Maltose", "C12H22O11", CAT_SUGARS, "Malt sugar disaccharide",
    ...
    { buildSucralose, "Sucralose", "C12H19Cl3O8", CAT_OTHER, "Chlorinated sugar",
    ...
    // === PESTICIDES (216-218) ===
    { buildDDT, "DDT", "C14H9Cl5", CAT_OTHER, "Pesticide",
    ...
    { buildGlyphosate, "Glyphosate", "C3H8NO5P", CAT_OTHER, "Herbicide",
    ...
    { buildMalathion, "Malathion", "C10H19O6PS2", CAT_OTHER, "Insecticide",
    ...
    // === FRAGRANCES (219-222) ===
    { buildVanillin, "Vanillin", "C8H8O3", CAT_FLAVORS, "Vanilla flavor",
    ...
    { buildLimonene, "Limonene", "C10H16", CAT_FLAVORS, "Citrus scent",
    ...
    { buildMenthol, "Menthol", "C10H20O", CAT_FLAVORS, "Cooling sensation",
    ...
    { buildCinnamaldehyde, "Cinnamaldehyde", "C9H8O", CAT_FLAVORS, "Cinnamon",
    ...
    // === LACHRYMATORY (223) ===
    { buildPropanethialSoxide, "Propanethial S-oxide", "C3H6OS", CAT_FLAVORS, "Makes you cry",
    ...
    { buildCFC12, "CFC-12", "CCl2F2", CAT_OTHER, "Ozone depleter",
    ...
    { buildSF6, "Sulfur Hexafluoride", "SF6", CAT_OTHER, "Potent GHG",
    ...
    // === ANESTHETICS (226-228) ===
    { buildLidocaine, "Lidocaine", "C14H22N2O", CAT_PHARMA, "Local anesthetic",
    ...
    { buildKetamine, "Ketamine", "C13H16ClNO", CAT_CONTROLLED, "Dissociative",
    ...
    { buildSevoflurane, "Sevoflurane", "C4H3F7O", CAT_PHARMA, "Inhalation anesthetic",
    ...
    { buildLSD, "LSD", "C20H25N3O", CAT_CONTROLLED, "Psychedelic",
    ...
    { buildPsilocybin, "Psilocybin", "C12H17N2O4P", CAT_CONTROLLED, "Magic mushroom",
    ...
    { buildMescaline, "Mescaline", "C11H17NO3", CAT_CONTROLLED, "Peyote cactus",
    ...
    { buildPCP, "PCP", "C17H25N", CAT_CONTROLLED, "Dissociative hallucinogen",
    ...
    { buildMDMA, "MDMA", "C11H15NO2", CAT_CONTROLLED, "Party drug",
    ...
    { buildMethylone, "Methylone", "C11H13NO3", CAT_CONTROLLED, "Synthetic cathinone",
    ...
    { buildValium, "Diazepam", "C16H13ClN2O", CAT_CONTROLLED, "Benzodiazepine tranquilizer",
    ...
    { buildMethamphetamine, "Methamphetamine", "C10H15N", CAT_CONTROLLED, "Powerful stimulant",
    ...
    { buildCodeine, "Codeine", "C18H21NO3", CAT_PHARMA, "Opioid pain reliever",
    ...
    { buildMethadone, "Methadone", "C21H27NO", CAT_PHARMA, "Synthetic opioid agonist",
    ...
    { buildDiphenhydramine, "Diphenhydramine", "C17H21NO", CAT_PHARMA, "1st gen antihistamine",
    ...
    { buildChlorpheniramine, "Chlorpheniramine", "C16H19ClN2", CAT_PHARMA, "1st gen antihistamine",
    ...
    { buildLoratadine, "Loratadine", "C22H23ClN2O2", CAT_PHARMA, "2nd gen antihistamine",
    ...
    { buildCetirizine, "Cetirizine", "C21H25ClN2O3", CAT_PHARMA, "2nd gen antihistamine",
    ...
    { buildFexofenadine, "Fexofenadine", "C32H39NO4", CAT_PHARMA, "2nd gen antihistamine",
    ...
    { buildPseudoephedrine, "Pseudoephedrine", "C10H15NO", CAT_PHARMA, "Decongestant",
    ...
    // ACE Inhibitors
    { buildLisinopril, "Lisinopril", "C21H31N3O5", CAT_PHARMA, "ACE inhibitor",
    ...
    { buildEnalapril, "Enalapril", "C20H28N2O5", CAT_PHARMA, "ACE inhibitor",
    ...
    { buildRamipril, "Ramipril", "C23H32N2O5", CAT_PHARMA, "ACE inhibitor",
    ...
    // ARBs
    { buildLosartan, "Losartan", "C22H23ClN6O", CAT_PHARMA, "ARB",
    ...
    { buildValsartan, "Valsartan", "C24H29N5O3", CAT_PHARMA, "ARB",
    ...
    { buildTelmisartan, "Telmisartan", "C33H30N4O2", CAT_PHARMA, "ARB",
    ...
    // Beta Blockers
    { buildMetoprolol, "Metoprolol", "C15H25NO3", CAT_PHARMA, "Beta blocker",
    ...
    { buildAtenolol, "Atenolol", "C14H22N2O3", CAT_PHARMA, "Beta blocker",
    ...
    { buildCarvedilol, "Carvedilol", "C24H26N2O4", CAT_PHARMA, "Beta blocker",
    ...
    { buildAmlodipine, "Amlodipine", "C20H25ClN2O5", CAT_PHARMA, "Calcium channel blocker",
    ...
    { buildDiltiazem, "Diltiazem", "C22H26N2O4S", CAT_PHARMA, "Calcium channel blocker",
    ...
    { buildNifedipine, "Nifedipine", "C17H18N2O6", CAT_PHARMA, "Calcium channel blocker",
    ...
    // Diuretics
    { buildHydrochlorothiazide, "Hydrochlorothiazide", "C7H8ClN3O4S2", CAT_PHARMA, "Diuretic",
    ...
    { buildFurosemide, "Furosemide", "C12H11ClN2O5S", CAT_PHARMA, "Diuretic",
    ...
    { buildSpironolactone, "Spironolactone", "C24H32O4S", CAT_PHARMA, "Potassium-sparing diuretic",
    ...
    // === ANTIVIRALS (264-269) ===
    { buildOseltamivir, "Oseltamivir", "C16H28N2O4", CAT_PHARMA, "Influenza antiviral",
    ...
    { buildNirmatrelvir, "Nirmatrelvir", "C23H32F3N5O4", CAT_PHARMA, "COVID protease inhibitor",
    ...
    { buildRitonavir, "Ritonavir", "C37H48N6O5S2", CAT_PHARMA, "Protease inhibitor",
    ...
    { buildMolnupiravir, "Molnupiravir", "C13H19N3O7", CAT_PHARMA, "COVID antiviral",
    ...
    { buildRemdesivir, "Remdesivir", "C27H35N6O8P", CAT_PHARMA, "COVID/Ebola antiviral",
    ...
    { buildDexamethasone, "Dexamethasone", "C22H29FO5", CAT_PHARMA, "Corticosteroid",
    ...
    { buildCubane, "Cubane", "C8H8", CAT_ORGANIC, "Cube-shaped",
    ...
    { buildBuckminsterfullerene, "Buckminsterfullerene", "C60", CAT_ORGANIC, "Carbon soccer ball",
    ...
    { buildAdamantane, "Adamantane", "C10H16", CAT_ORGANIC, "Diamond cage",
    ...
    { buildChlorophyll, "Chlorophyll a", "C55H72MgN4O5", CAT_ENERGY, "Plant pigment core",
    ...
    { buildRheniumChlorideDimer, "Rhenium Chloride Dimer", "Re2Cl8", CAT_OTHER, "Quadruple metal bond",
    ...
    { buildTungstenHexacarbonyl, "Tungsten Hexacarbonyl", "W(CO)6", CAT_OTHER, "Octahedral carbonyl",
    ...
    { buildDodecaborate, "Dodecaborate", "B12H12", CAT_OTHER, "Perfect icosahedron",
    ...
    { buildCatenane, "Catenane", "C70H76N4O10", CAT_OTHER, "Interlocked rings",
    ...
    { buildRotaxane, "Rotaxane", "C114H134N10O12", CAT_OTHER, "Ring on axle",
    ...
    { buildTrefoilKnot, "Molecular Trefoil Knot", "C81H75N9O9", CAT_OTHER, "Knotted loop",
    ...
    { buildPropellane, "Propellane", "C5H6", CAT_ORGANIC, "Inverted C-C bond",
